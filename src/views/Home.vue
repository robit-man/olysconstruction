...
.link{  position:absolute;z-index:5;text-align:center;bottom:calc(50vh - 280px);height:50px;font-size:1rem;color:#01449f; opacity:0.5; font-family: 'Bad Script', cursive;}
